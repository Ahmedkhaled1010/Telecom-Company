...
class ProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var cubit =ShopCupit.get(context).model;
    ...
    return BlocConsumer<ShopCupit,ShopStates>
      ...
      builder: (context,state)
      {
        ...
        return ConditionalBuilder(
            condition: ShopCupit.get(context).model != null && ShopCupit.get(context).categorymodel !=null,
            builder:(context)=> productsBuilder(ShopCupit.get(context).model,ShopCupit.get(context).categorymodel,context),
